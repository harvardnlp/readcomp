...
python preprocess-lambada.py --data ~/data/cnn/questions/ --glove ~/data/glove/glove.6B.100d.txt --extra_vocab entity_vocab.txt --out_file cnn.hdf5 --answer_identifier '@placeholder'
