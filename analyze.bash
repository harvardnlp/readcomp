...
CUDA_VISIBLE_DEVICES=1 python train2.py -datafile lambada.hdf5 -dropout 0.1 -std_feats -speaker_feats -emb_size 128 -rnn_size 128 -log_interval 1000 -bsz 64 -cuda -clip 10 -maxseqlen 1028 -mt_loss idx-loss -max_entities 2 -max_mentions 2 -epochs 1 -save 'models/pt-lambada.t7'

CUDA_VISIBLE_DEVICES=1 python train2.py -load 'models/pt-lambada.t7' -datafile lambada.hdf5 -dropout 0.1 -std_feats -speaker_feats -emb_size 128 -rnn_size 128 -log_interval 1000 -bsz 64 -cuda -clip 10 -maxseqlen 1028 -mt_loss idx-loss -max_entities 2 -max_mentions 2 -eval_only -analysis
