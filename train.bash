...
echo 'PREPROCESSING'
python preprocess.py --data ./entity-tracking-data/lambada/ --glove ./entity-tracking-data/glove.6B.100d.txt --train train.txt --valid valid.txt --test test.txt --std_feats --ent_feats --disc_feats --speaker_feats --out_file lambada.hdf5
